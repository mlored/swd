...
<div class="box-body">
	<div class="form-group ${hasErrors(bean: employeeInstance, field: 'number', 'error')}">
		...
		<g:textField name="name" class="form-control" maxlength="50"  placeholder="Nombre" required="" value="${employeeInstance?.name}" autofocus="autofocus" />
	</div>
	<div class="form-group ${hasErrors(bean: employeeInstance, field: 'number', 'error')}">
		<label for="surName">
		...
		<g:textField name="surName" class="form-control" maxlength="50" placeholder="Apellido" required="" value="${employeeInstance?.surName}"/>
	</div>
	<div class="form-group ${hasErrors(bean: employeeInstance, field: 'number', 'error')}">
		<label for="ruc">
		...
		<g:textField name="ruc" class="form-control" placeholder="Ruc" value="${employeeInstance?.ruc}" required=""/>
	</div>
	<div class="form-group ${hasErrors(bean: employeeInstance, field: 'number', 'error')}">
		<label for="address">
