	...
	<section class="content">
		...
		<div id="show-supplier" class="content scaffold-show" role="main">
			...
			<ol class="property-list supplier">
				...
				<li class="fieldcontain">
					<span id="model-label" class="property-label"><g:message code="supplier.surName.label" default="SurName" /></span>
				...
				<li class="fieldcontain">
					<span id="number-label" class="property-label"><g:message code="supplier.ruc.label" default="Ruc" /></span>
