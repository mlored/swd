...
<%@ page import="com.sd.isp.state.State" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-state" class="content scaffold-show" role="main">
			...
			<ol class="property-list state">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="state.name.label" default="Country" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${stateInstance.country}" field="name"/></span>
