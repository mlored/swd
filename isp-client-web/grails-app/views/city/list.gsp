...
<g:set var="entityName"
	value="${message(code: 'city.label', default: 'City')}" />
			...
			<thead>
				<tr>
					...
					<g:sortableColumn property="name"
						title="${message(code: 'city.name.label', default: 'Name')}" />
			...
			<tbody>
				<g:each in="${cityInstanceList}" status="i" var="cityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>
							${fieldValue(bean: cityInstance, field: "state.name")}
						</td>
						<td>
							${fieldValue(bean: cityInstance, field: "country.name")}
						</td>
					</tr>
				</g:each>
			</tbody>
