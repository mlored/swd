			...
			<ol class="property-list city">
				...
				<li class="fieldcontain">
					<span id="state-label" class="property-label"><g:message code="city.state.label" default="State" /></span>
						...
						<span class="property-value" aria-labelledby="state-label">${cityInstance?.state?.name?.encodeAsHTML()}</span>
					
				</li>
				</g:if>
			
			<g:if test="${cityInstance?.state?.country}">
				<li class="fieldcontain">
					<span id="state-label" class="property-label"><g:message code="city.state.label" default="country" /></span>
					
						<span class="property-value" aria-labelledby="state-label">${cityInstance?.state?.country?.name?.encodeAsHTML()}</span>
