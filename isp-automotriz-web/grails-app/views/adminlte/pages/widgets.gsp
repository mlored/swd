            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img class="img-circle" src="/static/dist/img/user1-128x128.jpg" alt="User Avatar">
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img class="img-circle" src="/static/dist/img/user3-128x128.jpg" alt="User Avatar">
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="box box-widget">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <img class="img-responsive pad" src="/static/dist/img/photo2.png" alt="Photo">
                        ...
                        <div class="box-footer box-comments">
                            ...
                            <div class="box-comment">
                                <!-- User image -->
                                <img class="img-circle img-sm" src="/static/dist/img/user4-128x128.jpg"
                                     alt="User Image">
                        ...
                        <div class="box-footer">
                            <form action="#" method="post">
                                <img class="img-responsive img-circle img-sm" src="/static/dist/img/user4-128x128.jpg"
                                     alt="Alt Text">
                            ...
                            <div class="attachment-block clearfix">
                                ...
                                <div class="attachment-pushed">
                                    <h4 class="attachment-heading"><a
                                            href="http://www.lipsum.com/">Lorem ipsum text generator</a></h4>
