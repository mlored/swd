...
public class PersonResource {
	...
	@PUT
	@Path("/{id}")
    public PersonDTO updateById(@PathParam("id") Integer personId, @RequestBody PersonDTO person) {
        return personService.updateById(personId, person);
    }
	
	@DELETE
	@Path("/{id}")
	@Produces("application/json")
	public PersonDTO delete(@PathParam("id") Integer personId) {
