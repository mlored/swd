...
<head>
    ...
    <script type="text/javascript" src="static/js/i18n/es.js"></script>
    <script type="text/javascript" src="static/js/localization/messages_es.js"></script>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="/taller-automotriz-web/j_spring_security_logout"  class="btn btn-default btn-flat"/>Salir</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar" style="height: auto;">
            ...
            <ul class="sidebar-menu tree" data-widget="tree">
                    ...
                    <li class="header">MENU</li>
                        ...
                        <li>
                            <a href="/taller-automotriz-web/report/list">
